...
function X.GetHeroLevelPoints()
	...
	table.insert(abilities, FrostNova:GetName())
	table.insert(abilities, FrostShield:GetName())
	table.insert(abilities, SinisterGaze:GetName())
	table.insert(abilities, ChainFrost:GetName())
